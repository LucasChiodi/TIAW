...
Clara: Clara, uma jovem estudante universitária, estava voltando para casa após sair do trabalho à noite. Enquanto caminhava por uma rua movimentada, um homem desconhecido começou a segui-la, fazendo gestos obscenos e se aproximando cada vez mais. Clara, sentindo-se ameaçada, pegou seu celular e fingiu ligar para a polícia, o que fez o homem desistir e fugir do local. Ela continuou caminhando nervosamente até chegar em casa, onde se sentiu aliviada por estar segura, mas abalada pela experiência.<br><br>
Renata: Renata, uma mulher de meia-idade, estava indo para o trabalho de manhã cedo quando foi abordada por um homem na rua. Ele começou a fazer comentários ofensivos sobre sua aparência e a seguir de perto, tornando-a desconfortável e com medo. Renata, sem saber como reagir, atravessou a rua e entrou em uma loja próxima, pedindo ajuda aos funcionários. Eles rapidamente a levaram para os fundos da loja e chamaram a polícia, enquanto o homem se afastava. Renata ficou abalada com o incidente, mas grata pela rápida intervenção que a manteve segura.<br><br>

<h3>Requisitos Funcionais </h3>
1: Possível aba de vendas de
produtos para defesa<br><br>
2: Gps e mapa visando mostrar a
localização de diversas outras
mulheres<br><br>
3: Forum para diversas conversas
de diversos temas<br><br>
4: Segurança<br><br>
5: Confiabilidade<br><br>
6: Manutençao<br><br>
7: Desempenho<br><br>
8: usabilidade <br><br>
9: tela de login <br><br>
10: conexão direta com os usuários e o canal de comunicação do app<br><br>

<h1>Projeto De Interface</h1>
<h3>Interface proposta com identificação visual e textual</h3>
<p> Segue o link para a interface proposta: https://www.figma.com/file/WnJHo5S38GuaohEd3xSYEb?node-id=0:1&locale=en&type=design</p>

<h1>Metodologia de trabalho</h1>

<h2>Ambientes Utilizados:</h2>
Estamos utilizando os ambientes Visual Studio code, GitHub, WhatsApp, figma e trello para utilizar o Kanban.

<h2>Ambiente de Controle de Código Fonte:</h2>
...
<h3>Introdução</h3>3Esta documentação explora os estágios do Kanban e sua forma de uso, bem como a integração do Scrumban. O Kanban é uma metodologia ágil que enfatiza a visualização do fluxo de trabalho, enquanto o Scrumban combina elementos do Scrum e do Kanban para otimizar o desenvolvimento de software. 

<h3>Estágios do Kanban</h3>
1. A Fazer:
No estágio "A Fazer", as tarefas são priorizadas e listadas como itens a serem realizados.
